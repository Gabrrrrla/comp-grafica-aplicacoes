...
for step_t in np.linspace(0, 1, 100):
    ...
    step_L3 = lerp(step_L2, step_L2[1], step_t)
    curva_x.append(step_L3)
...
# Linhas Nível 0 (Polígono de Controle)
...
ax.text(L0-0.2, L0[1]-0.2, '$P_0$', fontsize=14, color='#072A50')
ax.text(L0[1]-0.1, L0[1]+0.2, '$P_1$', fontsize=14, color='#072A50')
ax.text(L0[2]-0.1, L0[1, 2]+0.2, '$P_2$', fontsize=14, color='#072A50')
ax.text(L0[3]+0.1, L0[1, 3]-0.2, '$P_3$', fontsize=14, color='#072A50')
